...
function generateCss( opts ) {
  ...
  outlineColor = rgbaCss(
    opts['outline-color'],
    opts['outline-opacity']
  );
  ...
  if ( opts['include-border'] )      styles += 'border-color: '      + borderColor     + important + '; ';
  if ( opts['include-background'] )  styles += 'background-color: '  + backgroundColor + important + '; ';
  if ( opts['include-outline'] )     styles += 'outline: 1px solid ' + outlineColor    + important + '; ';
